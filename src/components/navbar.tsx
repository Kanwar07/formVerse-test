            ...
            >
              <div className="relative h-8 w-8">
                <img 
                  ...
                  alt="FormVerse Logo" 
                  className="h-8 w-8 elegant-glow-effect group-hover:animate-glow-pulse transition-all duration-500"
                />
              </div>
          ...
          <div className="hidden lg:flex items-center justify-center flex-1 mx-8">
            <div className="flex items-center space-x-1">
              <Button
                ...
                className={`elegant-button flex items-center space-x-2 text-sm rounded-2xl px-4 h-10 ${
            ...
            {user ? (
              <div className="flex items-center space-x-2">
                <Button
                  ...
                  className="elegant-button flex items-center space-x-2 bg-gradient-to-r from-white/10 to-white/5 border-white/20 hover:border-white/30 text-sm rounded-2xl px-4 h-10"
                >
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button 
                      variant="ghost" 
                      className="elegant-button flex items-center space-x-2 rounded-2xl px-4 h-10"
                    >
                      <User className="h-4 w-4" />
                      <span className="hidden sm:inline text-white/90 max-w-32 truncate">
                        {user.email}
                      </span>
                    </Button>
                  </DropdownMenuTrigger>
                  <DropdownMenuContent 
                    align="end" 
                    className="w-56 elegant-glass border-white/20 backdrop-blur-2xl"
                  >
                    <DropdownMenuItem 
                      onClick={() => navigate("/dashboard")} 
                      className="hover:bg-white/10 text-white/90 rounded-xl m-1"
                    >
                    ...
                    <DropdownMenuItem 
                      ...
                      className="text-red-400 hover:bg-red-500/10 rounded-xl m-1"
                    >
              ...
              <div className="flex items-center space-x-2">
                <Button
                  ...
                  className="elegant-button hover:bg-white/10 hover:text-white text-sm rounded-2xl px-4 h-10"
                >
                  Sign In
                </Button>
                <Button
                  onClick={() => navigate("/signup")}
                  className="elegant-button bg-gradient-to-r from-white/15 to-white/10 border-white/25 text-white hover:from-white/25 hover:to-white/15 hover:border-white/35 text-sm rounded-2xl px-4 h-10"
                >
                  Sign Up
                </Button>
              </div>
