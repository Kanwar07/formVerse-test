        ...
        <div className="flex h-20 items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-2">
            <Button
              ...
              className={`elegant-button flex items-center space-x-2 text-sm rounded-2xl px-4 py-2 h-10 ${
            ...
            {user ? (
              <div className="flex items-center space-x-3">
                <Button
                  ...
                  className="elegant-button flex items-center space-x-2 bg-gradient-to-r from-white/10 to-white/5 border-white/20 hover:border-white/30 text-sm rounded-2xl px-4 py-2 h-10"
                >
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button 
                      variant="ghost" 
                      className="elegant-button flex items-center space-x-2 rounded-2xl px-4 py-2 h-10"
                    >
              ...
              <div className="flex items-center space-x-3">
                <Button
                  ...
                  className="elegant-button hover:bg-white/10 hover:text-white text-sm rounded-2xl px-4 py-2 h-10"
                >
                  Sign In
                </Button>
                <Button
                  onClick={() => navigate("/signup")}
                  className="elegant-button bg-gradient-to-r from-white/15 to-white/10 border-white/25 text-white hover:from-white/25 hover:to-white/15 hover:border-white/35 text-sm rounded-2xl px-4 py-2 h-10"
                >
                  Sign Up
                </Button>
              </div>
